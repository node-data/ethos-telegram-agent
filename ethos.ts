...
export async function getDisplayName(userkey: string, profileData: any, searchInput: string): Promise<string> {
...
export function formatProfileMessage(profileData: any, userkey: string, ethosScore: number | null, displayName: string): string {
...
export function createProfileKeyboard(userkey: string, displayName: string): any {
